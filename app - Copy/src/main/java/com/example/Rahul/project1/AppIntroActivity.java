...
public class AppIntroActivity extends AppIntro {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance("Eye Catching Visuals", "Your Daily Statistics", R.drawable.appintro5, getResources().getColor(R.color.appintro3)));
        ...
        addSlide(AppIntroFragment.newInstance("", "Get Started", R.drawable.appintro2, getResources().getColor(R.color.appintro3)));
